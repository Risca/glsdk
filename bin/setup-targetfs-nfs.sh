...
echo "setenv bootargs 'root=/dev/nfs nfsroot=$ipaddr:$dst console=ttyO2,115200n8 earlyprintk rw ip=dhcp omapdrm.num_crtc=2 consoleblank=0 cma=64M'" >> boot.script.nfs
